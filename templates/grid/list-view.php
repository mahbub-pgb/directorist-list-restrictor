<?php
/**
 * Custom Directorist List Template with Login Notice
 * 
 * @author  wpWax
 * @since   6.6
 * @version 8.1
    ...
    <div class="<?php Helper::directorist_container_fluid(); ?>">
        ...
        <?php if ( $listings->have_posts() ) : ?>
            ...
            <div class="<?php Helper::directorist_row(); ?>">
                ...
                if ( $plugin_active && isset($saved_data['pre_sale']) && $listings->current_listing_type == $saved_data['pre_sale'] && ! is_user_logged_in() ) : ?>
                    ...
                    <?php
                    // Stop rendering list for this listing type
                    return;
                endif;
